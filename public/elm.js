...
var $author$project$Main$SaveModel = F4(
	function (notKnowingTasks, actionTasks, doneTasks, destroyedTasks) {
		return {b: actionTasks, c: destroyedTasks, d: doneTasks, a: notKnowingTasks};
	});
...
var $author$project$Main$Task = F4(
	function (id, content, category, destroyedAt) {
		return {p: category, N: content, G: destroyedAt, M: id};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(task.M)),
				_Utils_Tuple2(
				'content',
				$elm$json$Json$Encode$string(task.N)),
				_Utils_Tuple2(
				'category',
				...
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(task.G)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'notKnowingTasks',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Main$encodeTask, saveModel.a)),
				_Utils_Tuple2(
				'actionTasks',
...
var $author$project$Main$moveTasks = F4(
	function (model, taskId, fromCategory, toCategory) {
					...
					case 0:
						switch (_v1.b) {
							case 1:
								var _v2 = _v1.a;
								var _v3 = _v1.b;
								return A2(moveTask, model.a, model.b);
							case 2:
								var _v4 = _v1.a;
								var _v5 = _v1.b;
								return A2(moveTask, model.a, model.d);
							case 3:
								var _v6 = _v1.a;
								var _v7 = _v1.b;
								return A2(moveTask, model.a, model.c);
							default:
								break _v1$5;
						}
					case 1:
		...
		var newToDict = _v0.b;
		var notKnowingTasks = (!fromCategory) ? newFromDict : model.a;
		var actionTasks = (fromCategory === 1) ? newFromDict : ((toCategory === 1) ? newToDict : model.b);
		var destroyedTasks = (toCategory === 3) ? newToDict : model.c;
		var doneTasks = (fromCategory === 2) ? newFromDict : ((toCategory === 2) ? newToDict : model.d);
		...
		switch (msg.$) {
			case 0:
				if (model.v === '') {
					...
					var id = $elm$core$String$fromInt(
						$elm$time$Time$posixToMillis(model.t));
					var newNotKnowingTasks = A3(
						...
						A4(
							...
							model.v,
							0,
							$author$project$Main$getDestroyedAt(model.t)),
						model.a);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{v: '', a: newNotKnowingTasks}),
						$author$project$Main$saveTasks(
							$author$project$Main$encodeTasks(
								{b: model.b, c: model.c, d: model.d, a: newNotKnowingTasks})));
				}
			case 1:
				var content = msg.a;
				return _Utils_Tuple2(
					...
					F2(
						function (_v4, task) {
							return _Utils_cmp(
								...
								$elm$time$Time$posixToMillis(task.G)) > 0;
						}),
					model.a);
				...
				var newModel = function () {
					...
					if (_v1.b) {
						...
						return _Utils_update(
							model,
							{b: tasks.b, t: newTime, c: tasks.c, d: tasks.d, a: tasks.a});
					} else {
						return _Utils_update(
							model,
							{t: newTime});
			...
			case 4:
				...
				if (!_v5.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{b: loadedTasks.b, c: loadedTasks.c, d: loadedTasks.d, a: loadedTasks.a}),
						$elm$core$Platform$Cmd$none);
				} else {
					var x = _v5.a;
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{b: tasks.b, c: tasks.c, d: tasks.d, a: tasks.a}),
					$author$project$Main$saveTasks(
						$author$project$Main$encodeTasks(
							{b: tasks.b, c: tasks.c, d: tasks.d, a: tasks.a})));
		}
...
var $author$project$Main$viewTaskButtons = function (task) {
	...
	switch (_v0) {
		case 1:
			return A2(
				$elm$core$List$map,
				A2($author$project$Main$createMoveButton, task.M, task.p),
				_List_fromArray(
					[2, 3]));
		case 0:
			return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Main$computeTimeLeft, currentTime, task.G))
						]))
				]));
	});
var $author$project$Main$viewCategoryCell = F3(
	function (currentTime, category, task) {
		return A2(
			...
			_List_fromArray(
				[
					_Utils_eq(task.p, category) ? A3($author$project$Main$viewTask, currentTime, category, task) : $elm$html$Html$text('')
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewTaskRow(model.t),
